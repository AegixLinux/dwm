...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask, XK_grave, spawn, SHCMD("~/.local/bin/special-char-menu") },
	...
	{ MODKEY, XK_Insert, spawn, SHCMD("grep -v '^#' ~/.local/share/barbs/snippets | dmenu -i -l 50 | xclip -selection clipboard") },
